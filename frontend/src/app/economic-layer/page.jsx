...
<button className="px-8 py-3.5 rounded-full bg-primary-container text-on-primary font-label-md text-label-md shadow-md hover:opacity-95 hover:scale-[0.99] active:scale-[0.97] transition-all flex items-center gap-2">
...
</div></main><footer className="w-full bg-surface-container-lowest border-t border-surface-container py-space-xl px-gutter"><div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-space-lg"><div className="flex items-center gap-space-md"><img alt="AgentProof Logo" className="h-6 w-auto" src="https://lh3.googleusercontent.com/aida/AEtjO1UtHf8oOF7fpui2t5a8XHYBUKK1hPA7aojbputIJ7-vIK70l4wn_-gVrXL6jjUbQS6dtxQqET98K1RkDy66mpa8sS5b_98Zxicc9reYuomRQTrT_LcieztTSZs2fA73tDnzsjMA3MnNzHNmYLtXFnCB1m9NvCTyxZsRwu_kGdSaoEjZdaMsvK1i5i2_R9_j5qi8U6nNbyAiPMMbRznZRpwhqzGYvkf3u-NEtY1I8APNSlGLHo-UCNipKA"/><span className="font-body-sm text-body-sm text-secondary">© 2025 AgentProof Protocol. Trust-minimized economic settlement for autonomous agents.</span></div><div className="flex items-center gap-gutter"><Link className="font-label-sm text-label-sm text-secondary hover:text-on-surface transition-colors" href="#">Documentation</Link><Link className="font-label-sm text-label-sm text-secondary hover:text-on-surface transition-colors" href="#">Smart Contracts</Link><Link className="font-label-sm text-label-sm text-secondary hover:text-on-surface transition-colors" href="#">Validator Staking</Link></div></div></footer>
    </>
  );
}
