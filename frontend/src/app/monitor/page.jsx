...
export default function Monitor() {
  ...
  const copyAddress = () => {
    navigator.clipboard?.writeText('0x93b294c718fa40debc120938477e');
    setCopied(true);
...
<button
  className="hover:text-on-surface p-0.5 inline-flex items-center gap-1 cursor-pointer transition-colors"
  onClick={copyAddress}
