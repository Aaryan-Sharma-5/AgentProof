...
def build_langgraph_workflow():
    ...
    try:
        ...
        builder.add_node("validate_requirement", validate_requirement_node)
        builder.add_node("clarification", clarification_node)
        builder.add_node("discover_apis", discover_apis_node)
        builder.add_node("rank_apis", rank_apis_node)
        ...
        builder.add_node("create_payment_intent", create_payment_intent_node)
        builder.add_node("execute_payment", execute_payment_node)
        builder.add_node("wait_for_payment", wait_for_payment_node)
        ...
        builder.add_node("deliver_result", deliver_result_node)
        builder.add_node("handle_verification_failure", handle_verification_failure_node)
        builder.add_node("human_review", human_review_node)
        builder.add_node("finalize_request", finalize_request_node)
